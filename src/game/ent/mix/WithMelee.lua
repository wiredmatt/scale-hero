...
function WithMelee:applyMelee()
    ...
    self.animations["hit_right"] = TweenAnim(
      AnimationType.once,
    ...
    self.animations["hit_left"] = TweenAnim(
      AnimationType.once,
    ...
    self.animations["hit_down"] = TweenAnim(
      AnimationType.once,
    ...
    self.animations["hit_up"] = TweenAnim(
      AnimationType.once,
    ...
    self.animations["hit_down_right"] = TweenAnim( -- diagonal down right
      AnimationType.once,
    ...
    self.animations["hit_down_left"] = TweenAnim( -- diagonal down left
      AnimationType.once,
    ...
    self.animations["hit_up_left"] = TweenAnim( -- diagonal up left
      AnimationType.once,
    ...
    self.animations["hit_up_right"] = TweenAnim( -- diagonal up left
      AnimationType.once,
